...
def build_weekly_schedule(
    ...
    for _ in range(max_retries):
        ...
        # 5. Weekly local search optimization
        ...
        # 6. Weekly hard constraints
        if validate_week_hard_constraints(week, segments):
            return week
